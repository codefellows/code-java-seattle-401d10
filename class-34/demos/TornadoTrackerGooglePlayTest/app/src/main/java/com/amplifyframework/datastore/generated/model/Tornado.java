...
public final class Tornado implements Model {
  ...
  private final @ModelField(targetType="SuckedUpThing") @HasMany(associatedWith = "tornado", type = SuckedUpThing.class) List<SuckedUpThing> suckedUpThings = null;
  public String getId() {
      return id;
  }
  ...
  public List<SuckedUpThing> getSuckedUpThings() {
      return suckedUpThings;
  }
...
//        Person(teamid) -> Team Teamid should be saved in SharedPrefs
//        -> Tasks(personid)

//        Tornados saved in sqlLite use an int or a long -> we told viewholder to save that type
        // We should change the viewholder to save something that matches the type
//        we should save a string
