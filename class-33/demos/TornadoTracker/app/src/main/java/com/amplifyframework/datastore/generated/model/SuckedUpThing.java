...
public final class SuckedUpThing implements Model {
  ...
  private SuckedUpThing(String id, String name, Double longitude, Double latitude, Tornado tornado) {
    this.id = id;
    this.name = name;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, Double longitude, Double latitude, Tornado tornado) {
      super.id(id);
